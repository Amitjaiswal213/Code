//2) Apply Elbow method to calculate the optimum value of k. Modify your program to vary 
//the number of clusters, k, from 2 to 10. For each k calculate the sum squared error value. 
//Find the optimum k value for which lowest error is achieved
