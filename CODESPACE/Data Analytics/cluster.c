//1) Write a program in C language to Cluster a set of two dimensional Data points , using K-Means Clustering Algorithm. Consider fixed initial centroids, and value of k =2.
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
struct st
